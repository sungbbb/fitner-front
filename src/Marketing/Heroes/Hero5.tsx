    ...
    <Container py={{ base: "16", md: "24" }}>
      <SimpleGrid columns={{ base: 1, md: 2 }} gap={0}>
        <Stack
          ...
          borderLeftRadius={{ base: "none", md: 8000 }}
          borderTopRadius={{ base: 8000, md: "none" }}
          bgColor={"#f8f9f8"}
        >
          <Stack spacing={"4"} p={"16"} zIndex={111}>
        ...
        <AspectRatio ratio={2}>
          <Image
            borderRightRadius={{ base: "none", md: 8000 }}
            borderBottomRadius={{ base: 8000, md: "none" }}
            objectFit="cover"
        ...
        >
          <Stack spacing={"4"} p={"16"}>
            ...
            <Text fontSize={{ base: "sm", md: "md" }}>
              ...
              필요한 영양제를 추천해드립니다. 그리고 지속적인 상담을 통해 끝까지
              당신과 함께 건강의 대 변혁을 이끌어 갈 것입니다.
            </Text>
          </Stack>
        </Stack>
      </SimpleGrid>
