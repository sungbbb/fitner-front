...
export const testimonials = [
  {
    ...
    image: require("../../../Assets/reviewitem1.png"),
    quote:
      "개인 맞춤영양제 이다보니 내 건강 사항이 잘 반영된 약들로 구성되서 좋았고 특히 약사님이 끝까지 책임져 주셔서 좋았습니다. 귀찮게 많이 물어봤는데 잘 대답해주셔서 감사합니다~",
  },
  {
    ...
    image: require("../../../Assets/reviewitem2.png"),
    quote:
      "핏트너 진짜 최고입니다! 제 삶의 활력이 되었어요. 이제 복잡하게 영양제 섭취할 필요도 없고 광고 나올 때마다 혹할 필요도 없게 되었습니다. 이제 저는 영양제는 계속 핏트너만 믿을겁니다!",
  },
  {
    ...
    image: require("../../../Assets/reviewitem3.png"),
    quote:
      "생활습관 먹는 약 건강검진자료까지 분석해서 영양제를 추천해주시니 상당히 전문적이네요. 처음엔 잘 몰랐는데 약사님과 계속 이야기하다보니 정말 저한테 꼭 맞는 영양제를 섭취하게 된 것 같아요. 많이 추천하겠습니다. 고맙습니다",
  },
];
